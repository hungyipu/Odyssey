...
For flexibility, namespace structure in C++  is used for different tasks. Two default tasks are presented in the source code. Including :
 ...
 1. The redshift of a Keplerian disk [see example image](https://github.com/hungyipu/Odyssey/blob/master/task1.png)</li>
 2. The image of Keplerian rotating shell at 340GHz [see example image](https://github.com/hungyipu/Odyssey/blob/master/task2.png)</li>
